...
<!-- Mirrored from themewinter.com/html/news247/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Sep 2017 03:38:19 GMT -->
<head>
										      ...
										      <div class="tab-pane active animated fadeIn" id="tab-A">
										      	<div class="row">
										      		...
										      		<div class="col-md-3">
											      		<div class="post-block-style clearfix">
																<div class="post-thumb">
																	<a href="#"><img class="img-responsive" src="{{asset('/frontend/images/news/lifestyle/health2.jpg')}}" alt="" /></a>
																</div>
																<a class="post-cat" href="#">Health</a>
																<div class="post-content">
														 			<h2 class="post-title title-small">
										      		...
										      		<div class="col-md-3">
											      		<div class="post-block-style clearfix">
																<div class="post-thumb">
																	<a href="#"><img class="img-responsive" src="{{asset('/frontend/images/news/lifestyle/health3.jpg')}}" alt="" /></a>
																</div>
																<a class="post-cat" href="#">Health</a>
																<div class="post-content">
														 			<h2 class="post-title title-small">
										      		...
										      		<div class="col-md-3">
											      		<div class="post-block-style clearfix">
																<div class="post-thumb">
																	<a href="#"><img class="img-responsive" src="{{asset('/frontend/images/news/lifestyle/health4.jpg')}}" alt="" /></a>
																</div>
																<a class="post-cat" href="#">Health</a>
																<div class="post-content">
														 			<h2 class="post-title title-small">
									        ...
									        <div class="tab-pane animated fadeIn" id="tab-B">
									            <div class="row">
										      		<div class="col-md-3">
											      		<div class="post-block-style clearfix">
																<div class="post-thumb">
																	<a href="#"><img class="img-responsive" src="{{asset('/frontend/images/news/lifestyle/travel1.jpg')}}" alt="" /></a>
																</div>
										      		...
										      		<div class="col-md-3">
											      		<div class="post-block-style clearfix">
																<div class="post-thumb">
																	<a href="#"><img class="img-responsive" src="{{asset('/frontend/images/news/lifestyle/travel2.jpg')}}" alt="" /></a>
																</div>
																<a class="post-cat" href="#">Travel</a>
																<div class="post-content">
														 			<h2 class="post-title title-small">
										      		...
										      		<div class="col-md-3">
											      		<div class="post-block-style clearfix">
																<div class="post-thumb">
																	<a href="#"><img class="img-responsive" src="{{asset('/frontend/images/news/lifestyle/travel3.jpg')}}" alt="" /></a>
																</div>
																<a class="post-cat" href="#">Travel</a>
																<div class="post-content">
														 			<h2 class="post-title title-small">
									        ...
									        <div class="tab-pane animated fadeIn" id="tab-C">
									            <div class="row">
										      		<div class="col-md-3">
											      		<div class="post-block-style clearfix">
																<div class="post-thumb">
																	<a href="#"><img class="img-responsive" src="{{asset('/frontend/images/news/lifestyle/food1.jpg')}}" alt="" /></a>
																</div>
										      		...
										      		<div class="col-md-3">
											      		<div class="post-block-style clearfix">
																<div class="post-thumb">
																	<a href="#"><img class="img-responsive" src="{{asset('/frontend/images/news/lifestyle/food2.jpg')}}" alt="" /></a>
																</div>
																<a class="post-cat" href="#">Food</a>
																<div class="post-content">
														 			<h2 class="post-title title-small">
										      		...
										      		<div class="col-md-3">
											      		<div class="post-block-style clearfix">
																<div class="post-thumb">
																	<a href="#"><img class="img-responsive" src="{{asset('/frontend/images/news/lifestyle/food4.jpg')}}" alt="" /></a>
																</div>
																<a class="post-cat" href="#">Food</a>
																<div class="post-content">
														 			<h2 class="post-title title-small">
										...
										<div class="mega-menu-content-inner">
											<div class="row">
								      		<div class="col-md-3">
									      		<div class="post-block-style clearfix">
														<div class="post-thumb">
															<img class="img-responsive" src="{{asset('/frontend/images/news/video/video4.jpg')}}" alt="" />
								      		...
								      		<div class="col-md-3">
									      		<div class="post-block-style clearfix">
														<div class="post-thumb">
														   <img class="img-responsive" src="{{asset('/frontend/images/news/video/video3.jpg')}}" alt="" />
								      		...
								      		<div class="col-md-3">
									      		<div class="post-block-style clearfix">
														<div class="post-thumb">
														   <img class="img-responsive" src="{{asset('/frontend/images/news/video/video2.jpg')}}" alt="" />
								      		...
								      		<div class="col-md-3">
									      		<div class="post-block-style clearfix">
														<div class="post-thumb">
														   <img class="img-responsive" src="{{asset('/frontend/images/news/video/video1.jpg')}}" alt="" />
															<a class="popup" href="https://www.youtube.com/embed/DQNDcxRo-2M?autoplay=1&amp;loop=1">
														      <div class="video-icon">
														      	<i class="fa fa-play"></i>
														   	</div>
			...
			<div class="row">
				<div class="col-md-7 col-xs-12 pad-r">
					<div id="featured-slider" class="owl-carousel owl-theme featured-slider">
                        <div class="item" style="background-image:url('{{asset('/frontend/images/news/lifestyle/health5.jpg')}}')">
						...
						<div class="item" style="background-image:url('{{asset('/frontend/images/news/tech/gadget2.jpg')}}')">
							<div class="featured-post">
						 		<div class="post-content">
						...
						<div class="item" style="background-image:url('{{asset('/frontend/images/news/lifestyle/travel5.jpg')}}')">
							<div class="featured-post">
						 		<div class="post-content">
						 			<a class="post-cat" href="#">Travel</a>
						 			<h2 class="post-title title-extra-large">
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="post-overaly-style contentTop hot-post-top clearfix">
								<div class="post-thumb">
									<a href="#"><img class="img-responsive" src="{{asset('/frontend/images/news/tech/gadget4.jpg')}}" alt="" /></a>
								</div>
								<div class="post-content">
						 			<a class="post-cat" href="#">Gadget</a>
							...
							<div class="item">
								<ul class="list-post">
									<li class="clearfix">
										<div class="post-block-style clearfix">
											<div class="post-thumb">
												<a href="#"><img class="img-responsive" src="{{asset('/frontend/images/news/lifestyle/health5.jpg')}}" alt="" /></a>
											</div>
											<a class="post-cat" href="#">Health</a>
											<div class="post-content">
									 			<h2 class="post-title title-medium">
							...
							<div class="item">
								...
								<ul class="list-post">
									...
									<li class="clearfix">
										<div class="post-block-style clearfix">
											<div class="post-thumb">
												<a href="#"><img class="img-responsive" src="{{asset('/frontend/images/news/lifestyle/architecture3.jpg')}}" alt="" /></a>
											</div>
								...
								<ul class="list-post">
									<li class="clearfix">
										<div class="post-block-style clearfix">
											<div class="post-thumb">
												<a href="#">
													<img class="img-responsive" src="{{asset('/frontend/images/news/lifestyle/food3.jpg')}}" alt="" />
												</a>
											</div>
											<a class="post-cat" href="#">Food</a>
											<div class="post-content">
									...
									<ul class="list-post">
										...
										<li class="clearfix">
											<div class="post-block-style post-float clearfix">
												<div class="post-thumb">
													<a href="#">
														<img class="img-responsive" src="{{asset('/frontend/images/news/lifestyle/health1.jpg')}}" alt="" />
													</a>
													<a class="post-cat" href="#">Health</a>
												</div><!-- Post thumb end -->
										...
										<li class="clearfix">
											<div class="post-block-style post-float clearfix">
												<div class="post-thumb">
													<a href="#">
														<img class="img-responsive" src="{{asset('/frontend/images/news/lifestyle/travel2.jpg')}}" alt="" />
													</a>
													<a class="post-cat" href="#">Travel</a>
												</div><!-- Post thumb end -->
									...
									<ul class="list-post">
										...
										<li class="clearfix">
											<div class="post-block-style post-float clearfix">
												<div class="post-thumb">
													<a href="#">
														<img class="img-responsive" src="{{asset('/frontend/images/news/lifestyle/food2.jpg')}}" alt="" />
													</a>
													<a class="post-cat" href="#">Food</a>
												</div><!-- Post thumb end -->
										...
										<li class="clearfix">
											<div class="post-block-style post-float clearfix">
												<div class="post-thumb">
													<a href="#">
														<img class="img-responsive" src="{{asset('/frontend/images/news/lifestyle/architecture1.jpg')}}" alt="" />
													</a>
													<a class="post-cat" href="#">Architecture</a>
												</div><!-- Post thumb end -->
							...
							<div id="post-slide" class="owl-carousel owl-theme post-slide">
								...
								<div class="item">
									...
									<div class="post-overaly-style text-center clearfix">
									   <div class="post-thumb">
									      <a href="#">
									         <img class="img-responsive" src="{{asset('/frontend/images/news/lifestyle/health5.jpg')}}" alt="" />
									      </a>
									   </div><!-- Post thumb end -->
							...
							<ul class="list-post">
								...
								<li class="clearfix">
									<div class="post-block-style post-float clearfix">
										<div class="post-thumb">
											<a href="#">
												<img class="img-responsive" src="{{asset('/frontend/images/news/lifestyle/travel3.jpg')}}" alt="" />
											</a>
										</div><!-- Post thumb end -->
								...
								<li class="clearfix">
									<div class="post-block-style post-float clearfix">
										<div class="post-thumb">
											<a href="#">
												<img class="img-responsive" src="{{asset('/frontend/images/news/lifestyle/travel4.jpg')}}" alt="" />
											</a>
										</div><!-- Post thumb end -->
								...
								<ul class="list-post review-post-list">
									<li class="clearfix">
										<div class="post-block-style post-float clearfix">
											<div class="post-thumb">
												<a href="#">
													<img class="img-responsive" src="{{asset('/frontend/images/news/review/review1.jpg')}}" alt="" />
												</a>
											</div><!-- Post thumb end -->
									...
									<li class="clearfix">
										<div class="post-block-style post-float clearfix">
											<div class="post-thumb">
												<a href="#">
													<img class="img-responsive" src="{{asset('/frontend/images/news/review/review2.jpg')}}" alt="" />
												</a>
											</div><!-- Post thumb end -->
									...
									<li class="clearfix">
										<div class="post-block-style post-float clearfix">
											<div class="post-thumb">
												<a href="#">
													<img class="img-responsive" src="{{asset('/frontend/images/news/review/review3.jpg')}}" alt="" />
												</a>
											</div><!-- Post thumb end -->
									...
									<li class="clearfix">
										<div class="post-block-style post-float clearfix">
											<div class="post-thumb">
												<a href="#">
													<img class="img-responsive" src="{{asset('/frontend/images/news/review/review4.jpg')}}" alt="" />
												</a>
											</div><!-- Post thumb end -->
